...
def main(_argv):
    ...
    config = {
      "apiKey": "AIzaSyDo8VfX9IwtYdlB4vSznokAH-VadmSz9Cs",
      "authDomain": "alarm-limitasi-pengunjung.firebaseapp.com",
      "databaseURL": "https://alarm-limitasi-pengunjung-default-rtdb.firebaseio.com",
      "storageBucket": "alarm-limitasi-pengunjung.appspot.com"}
    ...
    while True:
        ...
        if FLAGS.count:
            ...
            db.update({"JumPengunjung" : 0})
            for key, value in counted_classes.items():
                print("Number of {}s: {}".format(key, value))
                db.update({"JumPengunjung" : value})
